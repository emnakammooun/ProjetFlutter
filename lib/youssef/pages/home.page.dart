  ...
  Widget build(BuildContext context) {
    ...
    return Consumer<YoussefUiProvider>(
      builder: (context, YoussefUiProvider notifier, child) {
        ...
        notifier.isDark ? CustomColor.scaffoldBg : Colors.white;
        ...
        return Scaffold(
          appBar: AppBar(
            title: Text(
              notifier.isEnglish
                  ? "My Portfolio"
                  : (notifier.isFrench ? "Mon Portfolio" : "السيرة الذاتية"),
              style: TextStyle(
                color: textColor,
              ),
            ),
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      notifier.isEnglish
                          ? "Education"
                          : (notifier.isFrench ? "Éducation" : "تعليم"),
                      style: TextStyle(
                        fontSize: 24,
                        fontWeight: FontWeight.bold,
                        color: textColor,
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      notifier.isEnglish
                          ? "Experience"
                          : (notifier.isFrench ? "Expérience" : "تجربة"),
                      style: TextStyle(
                        fontSize: 24,
                        fontWeight: FontWeight.bold,
                        color: textColor,
          ...
          floatingActionButton: FloatingActionButton(
            onPressed: () {
              Provider.of<YoussefUiProvider>(context, listen: false)
                  .toggleDarkMode();
            },
            child: Icon(
