    ...
    return Consumer<EmnaUiProvider>(
      builder: (context, EmnaUiProvider notifier, child) {
        ...
        return Scaffold(
          appBar: AppBar(
            title: Text(
              notifier.isEnglish ? "Mon portfolio" : "السيرة الذاتية",
              style: TextStyle(
                color: textColor,
              ),
            ),
            ...
            children: [
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      notifier.isEnglish ? "What I can do" : "ما يمكنني القيام به",
                      style: TextStyle(
                        fontSize: 24,
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      notifier.isEnglish ? "Education" : "التعليم",
                      style: TextStyle(
                        fontSize: 24,
                        fontWeight: FontWeight.bold,
                        color: textColor,
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      notifier.isEnglish ? "Experience" : "الخبرة",
                      style: TextStyle(
                        fontSize: 24,
                        fontWeight: FontWeight.bold,
                        color: textColor,
